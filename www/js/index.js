				...
				query.find({
					success:function(results) {
						...
						for(var i=0, len=results.length; i<len; i++) {
								...
								var figure = results[i];
								if( figure.get("Photo") != null){
								...
								s += '<div class="panel-heading"><h3 class="panel-title">'+figure.get("Name")+'</h3></div>';
								s += "<img src=" + figure.get("Photo").url() + ' height="80" width="80"><br/>';
								s += '<div class="panel-footer">'+figure.get("Series")+ '</div>';
